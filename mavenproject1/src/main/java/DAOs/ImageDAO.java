...
public class ImageDAO {
     public static int insertMultimedia(ModelUser user){
        Connection con = null;
        try{
            con = DbConnection.GetConnection();
            CallableStatement  command = con.prepareCall("INSERT INTO Multimedia (Usuario, Contraseña, Email, NivelDeAcceso, Descripción, ImagenAvatar) VALUES(?,?,?,?,?,?)");
